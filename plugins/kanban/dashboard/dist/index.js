...
(function () {
  ...
  const DOCS_URL = "https://little-agent.little-agent.com/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://little-agent.little-agent.com/docs/user-guide/features/kanban-tutorial";
