...
``_check_spotify_available()`` — when the user has not run ``little auth
spotify``, the tools remain registered (so they appear in ``little
...
The Spotify auth flow (``little auth spotify``), CLI plumbing, and docs
