...
required — uses aiohttp which is already a Little dependency.
...
def interactive_setup() -> None:
    ...
    ``little_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Little delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # little_cli/setup.py::_setup_mattermost function.
