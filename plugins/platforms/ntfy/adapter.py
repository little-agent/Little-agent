"""ntfy platform adapter (Little plugin).
...
``plugins/platforms/ntfy/``. The Little plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "little-in"              # subscribe topic (incoming)
          publish_topic: "little-out"     # optional — defaults to topic
...
async def _standalone_send(
    ...
    *,
    ...
    ``little cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Little dependency",
