# Little Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.little/plugins/little-achievements/state.json` (existing unlock state)
  - `~/.little/plugins/little-achievements/scan_snapshot.json` (new)
  - `~/.little/plugins/little-achievements/scan_checkpoint.json` (new)
