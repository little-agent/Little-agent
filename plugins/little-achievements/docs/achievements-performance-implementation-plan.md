# Little Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.little/plugins/little-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.little/plugins/little-achievements/scan_checkpoint.json`.
