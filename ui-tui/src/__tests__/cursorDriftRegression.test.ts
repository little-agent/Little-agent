 ...
 *
 * Symptom: in `little --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@little/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using little --tui and as i type multiline my caret at the end will often ' +
