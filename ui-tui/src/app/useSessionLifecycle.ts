...
import type { ScrollBoxHandle } from '@little/ink'
import { evictInkCaches } from '@little/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.LITTLE_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
