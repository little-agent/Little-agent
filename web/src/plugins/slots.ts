 ...
 * `window.__LITTLE_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Little brand in the top bar
 ...
 *  `window.__LITTLE_PLUGINS__.registerSlot(...)`.
 *
