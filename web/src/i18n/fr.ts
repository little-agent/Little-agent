...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateLittle: "Mettre à jour Little",
    updatingLittle: "Mise à jour de Little…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Little (parité avec `little plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.little/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.little/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.little/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badges Little à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Little en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Little davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Little détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Little analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Little Agent ☤",
    },
  },
  kanban: {
