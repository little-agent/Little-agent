...
const STORAGE_KEY = "little-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `little_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "little-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-little-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-little-theme-font", "true");
