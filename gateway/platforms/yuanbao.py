...
try:
    ...
    _LITTLE_VERSION = "0.0.0"

_APP_VERSION = _LITTLE_VERSION
_BOT_VERSION = _LITTLE_VERSION
_YUANBAO_INSTANCE_ID = str(LITTLE_INSTANCE_ID)  # single source: yuanbao_proto.LITTLE_INSTANCE_ID
