...
> **Android / Termux:** The tested manual path is documented in the [Termux guide](https://little-agent.nousresearch.com/docs/getting-started/termux). On Termux, Little installs a curated `.[termux]` extra because the full `.[all]` extra currently pulls Android-incompatible voice dependencies.
>
...
📖 **[Full documentation →](https://little-agent.nousresearch.com/docs/)**

---

## Skip the API-key collection — Nous Portal

Little works with whatever provider you want — that's not changing. But if you'd rather not collect five separate API keys for the model, web search, image generation, TTS, and a cloud browser, **[Nous Portal](https://portal.nousresearch.com)** covers all of them under one subscription:
...
That logs you in via OAuth, sets Nous as your provider, and turns on the Tool Gateway. Check what's wired up any time with `little portal status`. Full details on the [Tool Gateway docs page](https://little-agent.nousresearch.com/docs/user-guide/features/tool-gateway).
...
For the full command lists, see the [CLI guide](https://little-agent.nousresearch.com/docs/user-guide/cli) and the [Messaging Gateway guide](https://little-agent.nousresearch.com/docs/user-guide/messaging).

---

## Documentation

All documentation lives at **[little-agent.nousresearch.com/docs](https://little-agent.nousresearch.com/docs/)**:

| Section | What's Covered |
|---------|---------------|
| [Quickstart](https://little-agent.nousresearch.com/docs/getting-started/quickstart) | Install → setup → first conversation in 2 minutes |
| [CLI Usage](https://little-agent.nousresearch.com/docs/user-guide/cli) | Commands, keybindings, personalities, sessions |
| [Configuration](https://little-agent.nousresearch.com/docs/user-guide/configuration) | Config file, providers, models, all options |
| [Messaging Gateway](https://little-agent.nousresearch.com/docs/user-guide/messaging) | Telegram, Discord, Slack, WhatsApp, Signal, Home Assistant |
| [Security](https://little-agent.nousresearch.com/docs/user-guide/security) | Command approval, DM pairing, container isolation |
| [Tools & Toolsets](https://little-agent.nousresearch.com/docs/user-guide/features/tools) | 40+ tools, toolset system, terminal backends |
| [Skills System](https://little-agent.nousresearch.com/docs/user-guide/features/skills) | Procedural memory, Skills Hub, creating skills |
| [Memory](https://little-agent.nousresearch.com/docs/user-guide/features/memory) | Persistent memory, user profiles, best practices |
| [MCP Integration](https://little-agent.nousresearch.com/docs/user-guide/features/mcp) | Connect any MCP server for extended capabilities |
| [Cron Scheduling](https://little-agent.nousresearch.com/docs/user-guide/features/cron) | Scheduled tasks with platform delivery |
| [Context Files](https://little-agent.nousresearch.com/docs/user-guide/features/context-files) | Project context that shapes every conversation |
| [Architecture](https://little-agent.nousresearch.com/docs/developer-guide/architecture) | Project structure, agent loop, key classes |
| [Contributing](https://little-agent.nousresearch.com/docs/developer-guide/contributing) | Development setup, PR process, code style |
| [CLI Reference](https://little-agent.nousresearch.com/docs/reference/cli-commands) | All commands and flags |
| [Environment Variables](https://little-agent.nousresearch.com/docs/reference/environment-variables) | Complete env var reference |
...
We welcome contributions! See the [Contributing Guide](https://little-agent.nousresearch.com/docs/developer-guide/contributing) for development setup, code style, and PR process.
