...
(3 SDK retries x 3 Little retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_little_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".little")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Little, ...) behind one endpoint.  A 429 can mean either:
