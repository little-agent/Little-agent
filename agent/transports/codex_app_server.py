...
projection into Little' display, approval bridging, transcript projection into
...
"codex_app_server"`. Little' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("LITTLE_KANBAN_TASK"):
            kanban_db = spawn_env.get("LITTLE_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "LITTLE_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("LITTLE_HOME", os.path.expanduser("~/.little")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "little",
        client_title: str = "Little Agent",
