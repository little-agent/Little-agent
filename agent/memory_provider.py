...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - little_home (str): The active LITTLE_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.little``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "little").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'little memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], little_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'little memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``little_home`` is the active LITTLE_HOME directory path.
