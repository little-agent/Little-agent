...
def _has_little_agent_browser() -> bool:
    ...
    # install.sh installs globally into $LITTLE_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-LittleHome", str(get_little_home()),
        ]
    else:
