...
Invoked by ``little kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Little Agent board.
...
def _profile_author() -> str:
    """Mirror of ``little_cli.kanban._profile_author``."""
    return (
