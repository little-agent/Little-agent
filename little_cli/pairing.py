...
Usage:
    little pairing list              # Show all pending + approved users
    little pairing approve <platform> <code>  # Approve a pairing code
    little pairing revoke <platform> <user_id> # Revoke user access
    little pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle little pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: little pairing {list|approve|revoke|clear-pending}")
        print("Run 'little pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.little/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'little pairing list' to see pending codes.\n")
