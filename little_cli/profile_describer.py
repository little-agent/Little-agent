...
Used by ``little profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``little_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Little Agent kanban board.
...
Rules:
  ...
  - Never write "Little Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_little_home())
        else:
