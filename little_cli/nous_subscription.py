...
from little_cli.nous_account import NousPortalAccountInfo, get_nous_portal_account_info
...
def get_nous_subscription_features(
    ...
    *,
    ...
    # Tool Gateway via `little model`, so direct credentials should NOT
...
def prompt_enable_tool_gateway(
    ...
    *,
    ...
    try:
        from little_cli.setup import prompt_choice
    except Exception:
        return set()
