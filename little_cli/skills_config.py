"""
Skills configuration for Little Agent.
`little skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.little/config.yaml under:
...
from little_cli.config import cfg_get, load_config, save_config
from little_cli.colors import Colors, color
from little_cli.platforms import PLATFORMS as _PLATFORMS
