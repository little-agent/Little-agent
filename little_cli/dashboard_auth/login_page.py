...
Visual styling mirrors the Little Agent Team design system (the
...
``tests/little_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Little Agent</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Little Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Little Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
