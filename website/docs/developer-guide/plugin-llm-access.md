...
[`little-example-plugins`](https://github.com/NousResearch/little-example-plugins/tree/main/plugin-llm-example)
...
[`plugin-llm-async-example`](https://github.com/NousResearch/little-example-plugins/tree/main/plugin-llm-async-example)
in the same repo.
...
* Reference plugins (companion repo):
  * [`plugin-llm-example`](https://github.com/NousResearch/little-example-plugins/tree/main/plugin-llm-example) — sync structured extraction with image input
  * [`plugin-llm-async-example`](https://github.com/NousResearch/little-example-plugins/tree/main/plugin-llm-async-example) — async with `asyncio.gather()`
