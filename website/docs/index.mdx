...
slug: /
sidebar_position: 0
title: "Little Agent Documentation"
description: "The self-improving AI agent built by Little Agent Team. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by the Little Agent Team. The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/little-agent/Little-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
After installing, run `little setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Little Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Little safely |
| 🧭 **[Use MCP with Little](/guides/use-mcp-with-little)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Little](/guides/use-voice-mode-with-little)** | Hands-on setup and usage patterns for Little voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Little' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Little |
...
- **Built by model trainers** — Created by [Little Agent Team](https://little-agent.com), the lab behind Little, Nomos, and Psyche. Works with [Nous Portal](https://portal.little-agent.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. built by the Little Agent Team — the lab behind Little, Nomos, and Psyche models
