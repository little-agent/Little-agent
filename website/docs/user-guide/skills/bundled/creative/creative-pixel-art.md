...
```python
import sys
sys.path.insert(0, "/home/teknium/.little/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.little/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Little installs package this)
