...
```bash
python3 -m pyfiglet "LITTLE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=LITTLE&font=Slant" | boxes -d stone
```
