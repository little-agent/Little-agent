...
| | |
|---|---|
| Source | Optional — install with `little skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Little Agent |
| License | MIT |
...
Helper script path: `~/.little/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.little/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.little/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.little/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
