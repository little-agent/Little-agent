...
| | |
|---|---|
| Source | Optional — install with `little skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Little Agent |
| License | MIT |
...
The script reads `~/.little/.env` for two optional defaults:
...
Helper script: `~/.little/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.little/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.little/.env`.
...
```bash
python3 ~/.little/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.little/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
