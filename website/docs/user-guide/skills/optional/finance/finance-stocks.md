...
| | |
|---|---|
| Source | Optional — install with `little skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Little Agent |
| License | MIT |
...
```
SCRIPT=~/.little/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.little/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
