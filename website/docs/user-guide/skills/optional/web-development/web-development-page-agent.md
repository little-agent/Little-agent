...
- User wants **Little itself to drive a browser** → use Little' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
