...
| | |
|---|---|
| Source | Optional — install with `little skills install official/health/neuroskill-bci` |
...
Connect Little to a running [NeuroSkill](https://neuroskill.com/) instance to read
