...
| | |
|---|---|
| Source | Optional — install with `little skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Little Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $LITTLE_OSINT_CACHE/icij/ (default: ~/.cache/little-osint/icij/).
...
# Set LITTLE_OSINT_UA=your-app/1.0 (your@email) to identify yourself
