...
| | |
|---|---|
| Source | Optional — install with `little skills install official/research/qmd` |
...
Little Agent via the native MCP client. This is the preferred
...
Then configure Little Agent to connect via HTTP:
