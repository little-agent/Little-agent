...
| | |
|---|---|
| Source | Optional — install with `little skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Little","productType":"Apparel","tags":["test"]}}'
```
