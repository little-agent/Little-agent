  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Little Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Little &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Little?{' '}
        <a
          href="https://github.com/little-agent/Little-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/little-agent" target="_blank" rel="noopener noreferrer">
          Little Agent Discord
        </a>{' '}
