        ...
        {expanded && (
          <div className={styles.cardDetail}>
            ...
            <div className={styles.installHint}>
              <code>{skill.installCmd || `little skills install ${skill.name}`}</code>
            </div>
            {skill.docsPath && (
              <a
...
export default function SkillsDashboard() {
  ...
  return (
    <Layout
      title="Skills Hub"
      description="Browse all skills and plugins available for Little Agent"
    >
      <div className={styles.page}>
        <header className={styles.hero}>
          <div className={styles.heroGlow} />
          <div className={styles.heroContent}>
            <p className={styles.heroEyebrow}>Little Agent</p>
