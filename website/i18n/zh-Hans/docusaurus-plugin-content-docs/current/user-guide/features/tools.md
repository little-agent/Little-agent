...
付费 [Nous Portal](https://portal.little-agent.com) 订阅者可通过 **[Tool Gateway](tool-gateway.md)** 使用网页搜索、图像生成、TTS 和浏览器自动化——无需单独配置 API 密钥。运行 `little model` 启用，或通过 `little tools` 配置各工具。
:::
