...
Built for [Little Agent](https://github.com/little-agent/Little-agent). Usable in any coding agent. Canonical source lives here; synced to [`little-agent/Little-agent/skills/creative/ascii-video`](https://github.com/little-agent/Little-agent/tree/main/skills/creative/ascii-video) via PR.
