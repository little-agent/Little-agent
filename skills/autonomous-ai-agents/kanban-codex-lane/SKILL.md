...
description: Use when a Little Kanban worker wants to run Codex CLI as an isolated implementation lane while Little keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Little Agent
license: MIT
metadata:
  little:
    ...
    related_skills: [kanban-worker, codex, little-agent]
---
