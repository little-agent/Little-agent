...
VERSION_FILE = REPO_ROOT / "little_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "jake@little-agent.com": "simpolism",
    ...
    "little@marian.local": "Schrotti77",
    ...
    "teknium@little-agent.com": "teknium1",
    ...
    "274096618+little-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "shannon@little-agent.com": "shannonsands",
    ...
    "little@little-agent.com": "little-agent",
    ...
    "ben@little-agent.com": "benbarclay",
    ...
    "emozilla@little-agent.com": "emozilla",
    ...
    "jonny@little-agent.com": "yoniebans",
    "jake@little-agent.com": "simpolism",
    ...
    "little@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (LITTLE_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (LITTLE_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: little-eval community link)
    ...
    "littleagent26@gmail.com": "littleagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+littleagent26@users.noreply.github.com": "littleagent26",
    ...
    "clement@little-agent.com": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@little": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.little@agentmail.to": "oseftg",
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Little runtime files)
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"little-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "little@little-agent.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/little-agent/Little-agent",
    ...
    lines.append(f"# Little Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Little Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Little Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Little Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Little Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Little Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Little Agent v{new_version} ({calver_date})' "
