#!/usr/bin/env python3
"""Build the Little Model Catalog — a centralized JSON manifest of curated models.
...
Little CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Little release.
...
# Ensure LITTLE_HOME is set for imports that touch it at module level.
os.environ.setdefault("LITTLE_HOME", os.path.join(os.path.expanduser("~"), ".little"))

from little_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "little-agent repo",
            "docs": "https://little-agent.little-agent.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
