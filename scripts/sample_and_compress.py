...
DEFAULT_DATASETS = [
    "little-agent/swe-terminus-agent-glm-kimi-minimax",
    "little-agent/Little-agent-megascience-sft1",
    "little-agent/Little-agent-Thinking-GLM-4.7-SFT2",
    "little-agent/Little-agent-Thinking-GLM-4.7-SFT1",
    "little-agent/terminal-tasks-glm-little-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "little-agent/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload little-agent/{output_name} {final_output}")
