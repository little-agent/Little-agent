...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Little\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@little-agent.com",
    "cursoragent@cursor.com",
    "little@little-agent.com",
    "little-audit@example.com",
    "little@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "little-agent/Little-agent",
                "--state", "merged",
