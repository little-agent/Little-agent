#!/usr/bin/env python3
"""Build the Little Skills Index — a centralized JSON catalog of all skills.
...
`little skills search/install` can use it without hitting the GitHub API.
...
# Ensure LITTLE_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Little Skills Index...", flush=True)
