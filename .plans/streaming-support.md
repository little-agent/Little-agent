# Streaming LLM Response Support for Little Agent
...
```
LITTLE_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("LITTLE_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `little_cli/config.py` | 1 | +streaming config defaults |
