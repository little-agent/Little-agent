...
def _profile_user_agent() -> str:
    """Return a ``little-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from little_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"little-cli/{_ver}"
    except Exception:
        return "little-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # little-cli UA so the catalog endpoint is reachable.
