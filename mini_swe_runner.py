#!/usr/bin/env python3
"""
SWE Runner with Little Trajectory Format

A runner that uses Little-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Little-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Little-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Little format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Little-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Little-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Little Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Little-Agent's built-in execution environments
    and outputs trajectories in Little-Agent format.
    """
    ...
    def _convert_to_little_format(
        ...
        """
        Convert internal message format to Little trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Little trajectory format
        trajectory = self._convert_to_little_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Little trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Little Trajectory Format")
    print("=" * 60)
