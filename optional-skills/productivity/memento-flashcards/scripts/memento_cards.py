...
Data file: $LITTLE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_LITTLE_HOME = Path(os.environ.get("LITTLE_HOME", Path.home() / ".little"))
DATA_DIR = _LITTLE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
