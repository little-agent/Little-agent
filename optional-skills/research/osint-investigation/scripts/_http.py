...
DEFAULT_UA = (
    "little-osint-investigation/0.2 "
    "(+https://github.com/little-agent/Little-agent; "
    "set LITTLE_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("LITTLE_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
