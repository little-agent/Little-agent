...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("little_cli.config.get_config_path", return_value=config_path), \
             patch("little_cli.config.ensure_little_home"):
    ...
    def test_ensure_little_home_sets_0700(self):
        home = Path(self.tmpdir) / ".little"
        with patch("little_cli.config.get_little_home", return_value=home):
