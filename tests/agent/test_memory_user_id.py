...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_little_user(self):
        """Without user_id or config override, should default to 'little-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"LITTLE_HOME": "/tmp/test_little"}):
