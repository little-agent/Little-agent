...
def isolated_home(monkeypatch):
    """Temp LITTLE_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="little_test_31179_")
    little_home = os.path.join(test_home, ".little")
    os.makedirs(little_home)
...
def _fresh_modules():
    """Drop cached little modules so each test reloads against current env."""
