...
@pytest.fixture
def little_home(monkeypatch, tmp_path):
    """Isolate LITTLE_HOME so the tests don't pollute the real config.
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, little_home, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, little_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, little_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_new_file_written_as_is(self, little_home, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, little_home, tmp_path):
