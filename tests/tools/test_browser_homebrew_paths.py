...
class TestRunBrowserCommandPathConstruction:
    ...
    def test_subprocess_preserves_executable_path_with_spaces(self, tmp_path):
        ...
        browser_path = "/Users/test/Library/Application Support/little/node_modules/.bin/agent-browser"
        little_home = str(tmp_path / "little-home")
 ...
 patch("tools.browser_tool._chromium_installed", return_value=True), \
             ...
             patch("little_constants.Path.home", return_value=tmp_path), \
