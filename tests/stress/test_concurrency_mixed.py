...
def worker_loop(worker_id: int, little_home: str, result_file: str) -> None:
...
def reclaimer_loop(little_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="little_mixed_stress_")
    print(f"LITTLE_HOME = {home}")
