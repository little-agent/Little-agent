...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from little_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in LITTLE_OVERLAYS
        overlay = LITTLE_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify little doctor recognizes Xiaomi env vars."""
