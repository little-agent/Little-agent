"""Regression: little doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at little_cli/doctor.py already covers
Anthropic with the right headers, so the pluggable profile must be
skipped by `_build_apikey_providers_list()`.

See: little-agent/Little-agent#22346
"""
