...
def test_build_welcome_banner_title_is_hyperlinked_to_release():
    ...
    import little_cli.banner as _banner
    import model_tools as _mt
    import tools.mcp_tool as _mcp

    _banner._latest_release_cache = None
    tag_url = ("v2026.4.23", "https://github.com/little-agent/Little-agent/releases/tag/v2026.4.23")
    ...
    assert "Little Agent v" in raw, "Version label missing from title"
