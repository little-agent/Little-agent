"""Tests for the interactive session browser (`little sessions browse`).
...
from little_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """little sessions browse should be parseable."""
        from little_cli.main import main as _main_entry
