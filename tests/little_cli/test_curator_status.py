"""Tests for `little curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import little_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated LITTLE_HOME with real agent-created skills on disk."""
    ...
    from little_cli import curator as curator_cli
