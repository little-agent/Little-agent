...
The main() function in little_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `little -c model`
...
def _build_parser():
    """Build a minimal replica of the little top-level parser."""
