...
def test_new_command_rotates_little_session_id_env_and_context(tmp_path):
    ...
    assert cli.session_id != old_session_id
    assert os.environ["LITTLE_SESSION_ID"] == cli.session_id
    assert get_session_env("LITTLE_SESSION_ID") == cli.session_id
