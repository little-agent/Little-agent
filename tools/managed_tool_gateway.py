...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "little-agent.com"
...
def auth_json_path():
    """Return the Little auth store path, respecting LITTLE_HOME overrides."""
    return get_little_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from little_cli.auth import resolve_nous_access_token
