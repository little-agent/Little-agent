...
the get_anchored_view / get_messages_around primitives in little_state.
...
# Third-party integrations tag their sessions with LITTLE_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from little_state import DEFAULT_DB_PATH
