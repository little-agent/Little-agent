...
Trust levels:
  - builtin:   Ships with Little. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.little/\.env|\~/\.little/\.env',
     "little_env_access", "critical", "exfiltration",
     "directly references Little secrets file"),
    ...
    (r'\.little/config\.yaml|\.little/SOUL\.md',
     "little_config_mod", "critical", "persistence",
     "references Little configuration files directly"),
